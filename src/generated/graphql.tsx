...
export type BusStopQueryVariables = Exact<{
 ...
 * __useBusStopQuery__
 *
 * To run a query within a React component, call `useBusStopQuery` and pass it any options that fit your needs.
 * When your component renders, `useBusStopQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBusStopQuery({
 *   variables: {
 *      stopId: // value for 'stopId'
 *   },
 * });
 */
export function useBusStopQuery(baseOptions: Apollo.QueryHookOptions<BusStopQuery, BusStopQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BusStopQuery, BusStopQueryVariables>(BusStopDocument, options);
      }
export function useBusStopLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BusStopQuery, BusStopQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BusStopQuery, BusStopQueryVariables>(BusStopDocument, options);
        }
export type BusStopQueryHookResult = ReturnType<typeof useBusStopQuery>;
export type BusStopLazyQueryHookResult = ReturnType<typeof useBusStopLazyQuery>;
export type BusStopQueryResult = Apollo.QueryResult<BusStopQuery, BusStopQueryVariables>;